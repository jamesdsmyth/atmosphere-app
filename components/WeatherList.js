...
class WeatherList extends Component {
  ...
  render() {
    ...
    console.log(this.props.appState.weather);

    const weatherArray = this.props.appState.weather != null ? this.props.appState.weather.list : [];
    ...
    return (
      ...
      >
        ...
        {
          weatherArray.length === 0 && <Text style={styles.loadingText}>Loading your climate...</Text>
        }
